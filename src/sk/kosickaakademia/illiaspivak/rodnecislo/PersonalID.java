...
public class PersonalID {
    public boolean checkId(String id) {
        ...
        if(year<1954 && cDigits!=9){
            System.out.println("Chyba! Rodné číslo pridelené osobe narodenej do 31. decembra 1953 je deväťmiestne s trojmiestnou koncovkou");
            return false;
        }
        /*Rodné číslo pridelené osobe narodenej po 1954 musi byt deväťmiestne*/
        if(year>1953 && cDigits!=10){
            System.out.println("Chyba! Rodné číslo pridelené osobe narodenej po 1. januári 1954 je desaťmiestne so štvormiestnou koncovkou");
            return false;
        }
